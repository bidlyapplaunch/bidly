...
// Serve static files from the customer frontend build (after API routes)
const frontendDistPath = path.join(__dirname, '../auction-customer/dist');
console.log('📁 Serving customer frontend from:', frontendDistPath);
